...
async def setup(
    ...
    **kwargs,
    ...
    if log_fmt_console and log_datefmt:
        console_formatter = hub.lib.aiologger.formatters.base.Formatter(fmt=log_fmt_console, datefmt=log_datefmt)
    ...
    if log_fmt_logfile and log_file and log_datefmt and HAS_AIOFILES:
        file_formatter = hub.lib.aiologger.formatters.base.Formatter(fmt=log_fmt_logfile, datefmt=log_datefmt)
        file_handler = hub.lib.aiologger.handlers.files.AsyncFileHandler(filename=log_file)
